...
<head>
    ...
    <style>
        ...
        .container { width: 80%; margin: 50px auto; background: #F5F5Dc; padding: 20px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.2); }
        table { width: 100%; border-collapse: collapse; margin-top: 20px; }
        th, td { padding: 10px; border: 1px solid #ddd; }
        th { background-color:rgb(19, 23, 26); color: white; }
        ...
        .print-btn { background: green; color: white; margin-left: 10px; width: 20%; ;}
